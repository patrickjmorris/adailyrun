          ...
          <nav className="relative flex items-center justify-between sm:h-10 md:justify-center">
            <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
              <div className="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  <img className="h-8 w-auto sm:h-10" src="/md-star.svg" alt="" />
                </a>
          ...
          <div className="rounded-lg shadow-md">
            <div className="rounded-lg bg-white shadow-xs overflow-hidden">
              <div className="px-5 pt-4 flex items-center justify-between">
                <div>
                  <img className="h-8 w-auto" src="/md-sparkles.svg" alt="" />
                </div>
                <div className="-mr-2">
                  <button
                    type="button"
        ...
        <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Motivation and inspiration to get out the door and get in those miles.
            </p>
            <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <Link href="/runs">
                  <a className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-indigo-600 bg-white hover:text-indigo-500 focus:outline-none focus:shadow-outline-blue transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                    Browse Runs
                  </a>
                </Link>
              </div>
        ...
        <div className="relative lg:grid lg:grid-cols-3 lg:col-gap-8">
          ...
          <div className="mt-10 sm:grid sm:grid-cols-2 sm:col-gap-8 sm:row-gap-10 lg:col-span-2 lg:mt-0">
            <div>
              ...
              <div className="mt-5">
                <h5 className="text-lg leading-6 font-medium text-gray-900">Diverse Coaches</h5>
                <p className="mt-2 text-base leading-6 text-gray-500">
                  There's more to marathon training than old white dudes.
                </p>
              </div>
            </div>
            <div className="mt-10 sm:mt-0">
              ...
              <div className="mt-5">
                <h5 className="text-lg leading-6 font-medium text-gray-900">Race Training Plans</h5>
                <p className="mt-2 text-base leading-6 text-gray-500">
                  Go beyond the spreadsheet and learn what really goes into each run.
                </p>
              </div>
            </div>
            <div className="mt-10 sm:mt-0">
              ...
              <div className="mt-5">
                <h5 className="text-lg leading-6 font-medium text-gray-900">All Skill Levels Welcome</h5>
                <p className="mt-2 text-base leading-6 text-gray-500">
                  Whether you're training for the Olympics or your first run around the block. We have you
                  covered.
                </p>
              </div>
            </div>
